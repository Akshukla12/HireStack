    ...
    return (
        <main className="auth-shell">
            ...
            <div className="form-container">
                ...
                <p className="form-subtitle">Register to begin generating custom strategy roadmaps</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button className='button primary-button auth-btn'>Create Account</button>
                </form>
